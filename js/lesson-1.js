...
// } else if (min <= 30) {
//     alert(`${min} входить в другу в чверть`)
// } else if (min <= 45) {
...
// const num = Number(prompt("Введіть від 1 до 4"))
...
// const hour = String(Math.floor(number / 60));
...
//     // якщо число ділиться і на 3, і на 5
//     if (i % 3 === 0 && i % 5 === 0) {
